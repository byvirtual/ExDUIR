...
size_t CALLBACK _sysbutton_proc(HWND hWnd, EXHANDLE hObj, UINT uMsg, size_t wParam, size_t lParam, obj_s* pObj)
{
	int nError = 0;
	if (uMsg == WM_NCCREATE)
	{
...
size_t CALLBACK _page_proc(HWND hWnd, EXHANDLE hObj, UINT uMsg, size_t wParam, size_t lParam, obj_s* pObj)
{
